...
public class temp extends Configuration {
	...
	public static void Temporary_Arrangement() throws Exception {
		...
		try {
			...
			wait.until(ExpectedConditions
					.visibilityOf(Common_Property.driver.findElement(By.xpath("//div[text()='Open']")))).click();
			Thread.sleep(700);
			Common_Property.driver.findElement(By.xpath("//div[@name='MainUI.Open.Agreement Servicing']")).click();
			Thread.sleep(1750);
			Common_Property.driver.findElement(By.xpath("//div[@name='MainUI.Open.Maintain Customer Agreements']"))
			...
			String Str_Date = Common_Property.driver
					.findElement(By
							.xpath("/html/body/div[12]/div[2]/div/div/div/div/div[3]/div/div/div[2]/div[1]/div[1]/div/div[1]/div[8]"))
					.getAttribute("value");
			DateFormat formatter = new SimpleDateFormat("dd-MMM-yyyy");
			Calendar c = Calendar.getInstance();
			c.setTime(formatter.parse(Str_Date));
	...
	public static void BO_Settlement_Quote() throws IOException, InterruptedException, FilloException {
		...
		try {
			...
			Thread.sleep(10000); // ModifyDocumentRequestWindow.pbOK
		...
		try {
			...
			if (Validation.equalsIgnoreCase(status)) {
				...
				Common_Property.driver
						...
						.sendKeys(Driver.getData("VerificationData2"));
				Thread.sleep(1700);
		...
		for (int c_batch = 0; c_batch <= BatchList.size() - 1; c_batch++) {
			try {
				...
				String sysdate = Common_Property.driver
						...
						.getText();
				Driver.get_sysdate(sysdate, Driver.recordset2);
				...
				Common_Property.driver
						.findElement(By.xpath("/html/body/div[8]/div[2]/div/div/div/div/div/div[2]/div[2]")).click();
				Thread.sleep(2500);
				Common_Property.driver.findElement(By.xpath("/html/body/div[9]/div[2]/div/div/div[2]/input"))
						.sendKeys(Keys.F11);
				Common_Property.driver.manage().window().fullscreen();
				Thread.sleep(100);
				Common_Property.driver.findElement(By.xpath("/html/body/div[9]/div[2]/div/div/div[2]/input"))
				...
				Thread.sleep(500);
				Common_Property.driver
						.findElement(By.xpath("/html/body/div[8]/div[2]/div/div/div/div/div/div[4]/div[1]/div[2]"))
						.click();
				Thread.sleep(1500);
				...
				String Start = Common_Property.driver
						.findElement(By.xpath("/html/body/div[8]/div[2]/div/div/div/div/div/div[6]/div[1]/input"))
						.getAttribute("value");
				String stdate = Start.substring(0, 11);
				Common_Property.driver
						.findElement(By.xpath("/html/body/div[8]/div[2]/div/div/div/div/div/div[12]/input"))
						.sendKeys(Driver.add_days(sysdate,record));
				Thread.sleep(200);
				Common_Property.driver.findElement(By.xpath("//div[text()='Save']")).click();
				Thread.sleep(500);
				String days = Driver.recordset2.getField("No.of.days");
				...
				Common_Property.SQLcon = DriverManager.getConnection("jdbc:oracle:thin:@linux03:1524:IKANOTST", "forte",
						"forte");
				Common_Property.st = Common_Property.SQLcon.createStatement(Common_Property.rs1.TYPE_SCROLL_INSENSITIVE,
						Common_Property.rs1.CONCUR_UPDATABLE);
